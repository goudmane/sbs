...
Please install and activate it before starting to use the theme Lingvico.
...
Theme documentation is available on http://lingvico.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Lingvico is Fontello.
