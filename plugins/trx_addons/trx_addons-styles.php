...
if ( ! function_exists( 'lingvico_trx_addons_add_theme_vars' ) ) {
	add_filter( 'lingvico_filter_add_theme_vars', 'lingvico_trx_addons_add_theme_vars', 10, 2 );
	function lingvico_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'lingvico_trx_addons_get_css' ) ) {
	add_filter( 'lingvico_filter_get_css', 'lingvico_trx_addons_get_css', 10, 2 );
	function lingvico_trx_addons_get_css( $css, $args ) {
...
.trx_addons_audio_player .audio_author, .author_title,
.sc_team_default .sc_team_item_subtitle,
.sc_team_short .sc_team_item_subtitle,
.sc_team_featured .sc_team_item_subtitle,
.single-cpt_team .team_member_page .right-side-team .team_member_position, .sc_price_item_details, .sc_icons .sc_icons_item_title{
	{$fonts['p_font-family']}
}
...
.widget.widget_categories ul li a, .widget.widget_recent_comments ul > li, .widget.widget_recent_comments ul > li a, .widget.widget_recent_comments ul > li .comment-author-link,
.widget_calendar caption,
.sc_edd_details .downloads_page_tags .downloads_page_data > a,
.widget_product_tag_cloud a,
.widget_tag_cloud a,
.trx_addons_audio_player .audio_caption, .mejs-time,.sc_skills_pie.sc_skills_compact_off .sc_skills_item_title,
.sc_skills .sc_skills_item_title, 
.sc_skills .sc_skills_legend_title, 
.sc_skills .sc_skills_legend_value,  
.sc_price_item .sc_price_item_label, 
.sc_layouts_row_type_narrow  .sc_layouts_item_details_line2, .sc_layouts_item_details_line2, .footer-copyright,
.breadcrumbs, .sc_icons_item_description, .sticky .label_sticky, .post_categories a, .sticky .post_label, .post_date, .author_title .fn,
body table.booked-calendar th .monthName{
	{$fonts['h5_font-family']}
}
.comments_wrap .comments_field input, .comments_wrap .comments_field textarea,
.strong-view .strong-content .testimonial .testimonial-inner .testimonial-client .testimonial-name,
.strong-view .strong-content .testimonial .testimonial-inner .testimonial-client .testimonial_course, .form-field.field-rating .after, .form-field.field-rating .before,
ul.custom_list_style li, .sc_googlemap_content ul li a, .sc_googlemap_content ul li span, ol.trx_addons_list.trx_addons_list_number li:before,
.sc_blogger_filters ul.sc_blogger_filters_titles li a .trx_addons_extended_taxonomy span,
.sc_blogger.sc_blogger_default .sc_blogger_item .course-price,
.sc_blogger.sc_blogger_default .sc_blogger_item_content .blogger_post_footer, .sc_blogger_pagination .nav-links,
.lp-single-course .course-price .price, .course-landing-summary .course-students{
...
.trx_addons_tooltip:after {
	border-top-color: {$colors['extra_bg_hover']};
}
...
.sc_blogger_default .sc_blogger_item_excerpt_text p, .sc_blogger_item_content .blogger_post_footer{
...
.sc_blogger_item_content .blogger_post_footer .post_meta_item{
	color: {$colors['inverse_light']};
}
.sc_blogger_item_content .blogger_post_footer a.post_meta_item:hover{
	color: {$colors['text_link']};
}
...
.sc_blogger_filters ul.sc_blogger_filters_titles li a:hover{
    background-color: {$colors['extra_hover2']};
    color: {$colors['extra_bd_color']};
}
...
.sc_blogger.sc_blogger_excerpt .trx_addons_audio_wrap .trx_addons_audio_navigation>span span:hover{
    color: {$colors['text_link']};
}
.mejs-time-float-corner{
    border-color:{$colors['text_link2']} transparent transparent;
}
.mejs-time-float{
...
.sc_blogger.sc_blogger_excerpt .mejs-controls .mejs-time-rail .mejs-time-total,
.sc_blogger.sc_blogger_excerpt .mejs-controls .mejs-time-rail .mejs-time-loaded, 
.sc_blogger.sc_blogger_excerpt .mejs-controls .mejs-time-rail .mejs-time-hovered,
.sc_blogger.sc_blogger_excerpt .mejs-controls .mejs-volume-slider .mejs-volume-total,
.sc_blogger.sc_blogger_excerpt .mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total{
    background-color: {$colors['alter_bg_color']};
}
.sc_blogger.sc_blogger_excerpt .trx_addons_audio_player{
    background-color: {$colors['bg_color']};
}

.sc_blogger.sc_blogger_default .sc_blogger_item_content .blogger_post_footer .blogger_course_duration:before,
.sc_blogger.sc_blogger_default .sc_blogger_item_content .blogger_post_footer .post_counters_item.post_counters_comments:before{
    color: {$colors['extra_link']}; 
}
...
.sc_price_item.best_price_label .sc_price_item_info{
	border-color: {$colors['text_hover']};
}
.sc_price_item.best_price_label .sc_price_item_link{
	background-color: {$colors['text_hover']}!important;
}
.sc_price_item.best_price_label .sc_price_item_link:hover{
...
.default-bg-team .sc_team_default .sc_team_item_info {
	color: {$colors['alter_text']};
	background-color: {$colors['bg_color']};
}
...
.widget.widget_popular_posts .trx_addons_tabs_content .post_item .post_thumb .post_categories a:hover{
   color: {$colors['text_link']};
}
.widget.widget_popular_posts .trx_addons_tabs_content .post_item .post_info_posted a{
     color: {$colors['text_light']};
}
.widget.widget_popular_posts .trx_addons_tabs_content .post_item .post_info_posted a:hover{
     color: {$colors['text_link']};
}
...
.testimonials_bg_white .strong-view.default .testimonial{
    background-color: {$colors['bg_color']};
}
.strong-view .strong-content .testimonial .testimonial-inner .testimonial-client .testimonial-name{
    color: {$colors['text_dark']};
...
.strong-form input[type="url"]:focus,
.strong-form input[type="file"]:focus,
.strong-form select:focus,
...
ul.learn-press-courses li a:hover .course-title{
    color: {$colors['text_link']};
}
...
.learn-press-nav-tabs.course-nav-tabs li:hover a,
.learn-press-nav-tabs.course-nav-tabs li.active a{
    background-color: {$colors['text_link']};
	color: {$colors['alter_bd_color']};
}
.content-item-scrollable .mejs-controls .mejs-button>button:hover,
.content-item-scrollable .mejs-controls .mejs-button>button:focus{
   color: {$colors['alter_bd_color']}; 
}
...
.learnpress .learn-press-checkout a:last-child:hover,
.learnpress .learn-press-form .checkout-form-login-toggle:hover,
.learnpress .learn-press-form .checkout-form-register-toggle:hover {
    background-color: {$colors['text_hover']};
}
...
.learnpress .learn-press-checkout a:last-child:hover:after {
    background-color: {$colors['text_hover']};
}
